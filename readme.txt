...
= Documentation =
Documentation can be found [here](https://www.tychesoftwares.com/docs/docs/flexslider/)
...
* Visit the plugin's [Documentation](https://www.tychesoftwares.com/docs/docs/flexslider/) for setup and configuration information
